...
async function sendVerificationEmail(email: string, link: string) {
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      ...
      clientId:'938483265338-0cc5g2ifrcnf79cej5i7fn5i58unu9j6.apps.googleusercontent.com',
      clientSecret:'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',
      refreshToken:'1//03gzjsrSr1eDOCgYIARAAGAMSNwF-L9IriEELA3XFb_KFRtSGVfGUUElRvirkv1A5voYzCxhhLskpgQ9y4k5F5ezou5C5NJjjS4c'
    },
    secure: true,
  });
